...
mkdir -p /config/pingo_doce_plus /config/custom_components

# Instala/atualiza automaticamente a custom integration incluída no add-on.
rm -rf /config/custom_components/pingo_doce_plus
cp -a /app/custom_components/pingo_doce_plus /config/custom_components/pingo_doce_plus
